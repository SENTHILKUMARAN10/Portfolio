...
export function TimelineDemo() {
  const data = [
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 text-neutral-200 text-xs md:text-sm font-normal mb-8">
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 text-neutral-200 text-xs md:text-sm font-normal mb-4">
